...
function ai() {
    ...
    var aiactive = document.getElementById("ai_active");
    var ai_active = aiactive.getElementsByTagName("li");
    var content2_ai_right = document.getElementsByClassName("content2_ai_right");
    for(var i=0;i<ai_active.length;i++){
        ai_active[i].index = i ;
        content2_ai_right[0].style.display = "block" ;
        ai_active[i].onmouseenter = function(){
           
            for(var j=0;j<ai_active.length;j++){
               
                ai_active[j].className = "" ;
                content2_ai_right[j].style.display = "none";
            }
            content2_ai_right[this.index].style.display = "block" ;
            this.className = "ai_active" ;
        }
    }

//鼠标移上去效果
    var right = document.getElementById("content2_right");
